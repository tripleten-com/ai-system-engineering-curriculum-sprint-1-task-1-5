...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/tripleten-com/ai-system-engineering-curriculum-sprint-1-task-1-5/tree/main)
...
For Task 1.5, `poe verify` runs readiness, capacity-answer checks, and answer/protected-path checks.
...
Use the Task 1.5 lesson to decide what evidence to collect. This README covers local setup and
