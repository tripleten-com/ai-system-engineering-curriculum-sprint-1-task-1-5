...
# Task 1.5's own boundary: a submitted PR may touch only the answer sheet. Keep this in sync
# with submission_validation.ALLOWED_PATHS.
...
def test_submission_change_stays_within_the_permitted_diff() -> None:
    """Catch a submitted change that reaches outside Task 1.5's submission-only boundary."""
